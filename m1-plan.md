...
- [x] [#95](https://github.com/logact/becoming/issues/95) — Implement Task-to-Project membership relations (Feature #18) **(done)**
...
- [x] [#102](https://github.com/logact/becoming/issues/102) — Query bounded Goal and Task hierarchies (Feature #21) **(done)**
...
- [x] [#83](https://github.com/logact/becoming/issues/83) — Calculate project and task resource balances (Feature #15) **(done)**
- [ ] [#103](https://github.com/logact/becoming/issues/103) — Compose current and historical Project execution snapshots (Feature #22) **(processing)**
...
| [#42](https://github.com/logact/becoming/issues/42) | Approximate (worker did not capture boundaries) | Approximate | ~11m | Unavailable (worker runtime did not expose it) | [`d3ce6d4`](https://github.com/logact/becoming/commit/d3ce6d463f6f372c6e71386f0e54a3b240c2fcd3) |
| [#55](https://github.com/logact/becoming/issues/55) | Approximate (worker did not capture boundaries) | Approximate | ~12m | Unavailable (worker runtime did not expose it) | [`b76f713`](https://github.com/logact/becoming/commit/b76f713) |
| [#62](https://github.com/logact/becoming/issues/62) | Approximate (worker did not capture boundaries) | Approximate | ~12m | Unavailable (worker runtime did not expose it) | [`dcfdbda`](https://github.com/logact/becoming/commit/dcfdbda48e92274c0e3d3c8a5dbf347052ba2f95) |
| [#43](https://github.com/logact/becoming/issues/43) | Approximate (worker did not capture boundaries) | Approximate | ~12m | Unavailable (worker runtime did not expose it) | [`098e352`](https://github.com/logact/becoming/commit/098e352fe78f6c98ec661f0d16441cd1182b3386) |
| [#48](https://github.com/logact/becoming/issues/48) | Approximate (worker did not capture boundaries) | Approximate | ~15m | Unavailable (worker runtime did not expose it) | [`7d97c7e`](https://github.com/logact/becoming/commit/7d97c7e) |
| [#63](https://github.com/logact/becoming/issues/63) | Approximate (worker did not capture boundaries) | Approximate | ~18m | Unavailable (worker runtime did not expose it) | [`f9aacdd`](https://github.com/logact/becoming/commit/f9aacdd) |
